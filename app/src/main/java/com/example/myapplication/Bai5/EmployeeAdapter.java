...
import com.example.myapplication.Bai5.Bai5_Employee;
import com.example.myapplication.R;

import java.util.List;

public class EmployeeAdapter extends ArrayAdapter<Bai5_Employee> {
    private Activity context=null;
    private int layoutID;
    private List<Bai5_Employee> objects=null;
    public EmployeeAdapter(Activity context, int layoutID, List<Bai5_Employee>
            objects) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        if (convertView == null) {
            convertView =
                    LayoutInflater.from(context).inflate(R.layout.bai5_item, null,
                            false);
        }
        // Get item
        Bai5_Employee employee = getItem(position);
        // Get view
